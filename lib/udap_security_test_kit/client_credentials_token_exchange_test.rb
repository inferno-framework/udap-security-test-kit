...
module UDAPSecurityTestKit
  class ClientCredentialsTokenExchangeTest < Inferno::Test
    ...
    input :udap_client_credentials_client_keyset_source,
    ...
    run do
      ...
      if udap_client_credentials_client_keyset_source == 'Custom'
        ...
        client_assertion_jwt = UDAPSecurityTestKit::UDAPJWTBuilder.encode_jwt_with_x5c_header(
          ...
          udap_client_credentials_flow_client_private_key_pem,
          udap_jwt_signing_alg,
          x5c_certs
        )
      elsif udap_client_credentials_client_keyset_source == 'SureFhir'
      ...
      elsif udap_client_credentials_client_keyset_source == 'EMRDirect'
