module UDAPSecurityTestKit
  class CommunityParameterSupportAttestationTest < Inferno::Test
    ...
    description %(
      Server supports the `community` parameter correctly by selecting a certificate intended for use within the identified trust community when generating the signed JWT for the `signed_metadata` element.
    )
